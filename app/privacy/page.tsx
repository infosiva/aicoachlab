export default function PrivacyPage() {
  return (
    <main style={{ maxWidth: 720, margin: '0 auto', padding: '60px 24px', fontFamily: 'system-ui', lineHeight: 1.7, color: '#f0f4ff' }}>
      <h1 style={{ fontSize: 32, fontWeight: 800, marginBottom: 8 }}>Privacy Policy</h1>
      <p style={{ color: '#a5b4fc', marginBottom: 40 }}>Last updated: June 2026</p>

      <h2 style={{ fontSize: 20, fontWeight: 700, marginTop: 32 }}>What we collect</h2>
      <p>AICoachLab collects only information you provide directly — such as your email address when you sign up, and anonymous usage data to improve the service. We do not sell your data.</p>
      ...
      <p>You can request deletion of your account and data at any time by emailing <a href="mailto:hello@aicoachlab.app" style={{ color: '#818cf8' }}>hello@aicoachlab.app</a>.</p>

      <h2 style={{ fontSize: 20, fontWeight: 700, marginTop: 32 }}>Contact</h2>
      <p>Questions? Email <a href="mailto:hello@aicoachlab.app" style={{ color: '#818cf8' }}>hello@aicoachlab.app</a></p>
    </main>
  )
}
